...
$jscomp.getGlobal = function (k) {
    ...
    throw Error("Impossible de trouver l'objet global");
};
...
(function (k) {
    ...
    function ma(a) {
        ...
        if (a) {
            ...
            !a.sEmptyTable && d && "Aucune donnée disponible" === b.sEmptyTable && V(a, a, "sZeroRecords", "sEmptyTable");
    ...
    function La(a, b, c) {
        ...
        n = {
            ...
            error: function (m, p, t) {
                ...
                -1 === k.inArray(!0, t) && ("parsererror" == p ? aa(a, 0, "Réponse JSON non valide", 1) : 4 === m.readyState && aa(a, 0, "Ajax error", 7));
                U(a, !1);
            },
        };
        a.oAjaxData = b;
    ...
    u.defaults = {
        ...
        oLanguage: {
            ...
            oPaginate: { sFirst: "Premiére", sLast: "Derniére", sNext: "Suivante", sPrevious: "Précedente" },
            sEmptyTable: "Aucune donnée disponible",
            sInfo: "Ligne _START_ à _END_ sur _TOTAL_ Lignes",
            sInfoEmpty: "Ligne 0 à 0 sur 0 Lignes",
            sInfoFiltered: "(filtré sur _MAX_ lignes au total)",
            sInfoPostFix: "",
            sDecimal: "",
            sThousands: ",",
